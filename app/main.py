...
@app.route("/download_project_log/<name>")
def download_project_log(name):
    project_path = os.path.join("projects", name, "execution_log.json")
    if os.path.exists(project_path):
        return send_file(project_path, mimetype="application/json", as_attachment=True, download_name=f"{{name}}_execution_log.json")
